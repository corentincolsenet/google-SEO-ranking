                                ...
                                <div className="text-white lg:w-1/2 lg:mx-6">
                                    ...
                                    <div className="mt-6 md:mt-8">
                                        ...
                                        <div className="flex mt-4 -mx-1.5 ">
                                            <a className="mx-1.5 text-white transition-colors duration-300 transform hover:text-tertiary" href="#">
                                    ...
                                    <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl lg:max-w-xl">
                                        ...
                                        <form className="mt-6">
                                            ...
                                            <div className="flex-1 mt-6">
                                                ...
                                                <input type="email" placeholder="johndoe@example.com" className="block w-full px-5 py-3 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md focus:outline-none" />
                                            </div>

                                            <div className="w-full mt-6">
                                                <label className="block mb-2 text-sm text-gray-600">Message</label>
                                                <textarea className="block w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md md:h-48 focus:outline-none" placeholder="Message"></textarea>
                                            </div>

                                            <button
                                                onSubmit={(e) => onSubmit(e)}
                                                className="w-full px-6 py-3 mt-6 text-sm font-medium bg-secondary text-white capitalize rounded-md hover:bg-tertiary focus:outline-none"
                                            >
                                                get in touch
                                            </button>
                                        </form>
