            ...
            <div className="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
              <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
                <div className="md:h-7/12 lg:w-6/12">
                  ...
                  <p className="mt-6 text-gray-600">The knowledge of the elves in the Abeth Forest near Laisy helped us building a magical bell.</p>
                ...
                <div className="md:h-5/12 lg:w-5/12">
                  <img className="rounded-xl" src="/images/about-bell-ring.png" alt="xeofood bell that you ring to pass thy order in xeozrodel" loading="lazy" width="" height="" />
                </div>
              </div>
            </div>
          </div>
